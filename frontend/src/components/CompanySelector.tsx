    ...
    <div className="company-selector relative">
      ...
      {!disabled && (
        <button
          ...
          className="w-full px-3 py-2 border border-gray-300 rounded-lg text-left text-gray-600 hover:border-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
        >
              ...
              filteredCompanies.map(company => (
                ...
                >
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${
                    company.company_type === 'customer' ? 'bg-blue-100 text-blue-700' :
