 ...
 */
import { z } from 'zod';
import { COMMUNICATION_INPUT_MIN_LENGTHS } from '@/lib/uiInputRules';
...
export const documentCreateSchema = z.object({
  ...
  release_branch: z
    ...
    .optional()
    .or(z.literal('')),
  tags: z.string().max(2000, 'Tags must be at most 2,000 characters').optional().or(z.literal('')),
});
...
export const feedbackSchema = z.object({
  ...
  content: z
    .string()
    .min(
      COMMUNICATION_INPUT_MIN_LENGTHS.feedbackContent,
      `Feedback must be at least ${COMMUNICATION_INPUT_MIN_LENGTHS.feedbackContent} characters`
    )
...
export const profileUpdateSchema = z.object({
  ...
  timezone: z
    ...
    .optional()
    .or(z.literal('')),
  locale: z.string().max(10, 'Locale must be at most 10 characters').optional().or(z.literal('')),
});
