...
def test_assign_companies_not_found_uses_domain_error_mapping(client, admin_headers):
...
def test_assign_companies_invalid_set_uses_domain_error_mapping(client, admin_headers, sample_document):
    response = client.post(
...
def test_publish_version_conflict_uses_domain_error_mapping(client, admin_headers, sample_document):
