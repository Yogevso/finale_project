...
READ_ENDPOINT_DEFINITIONS: tuple[_EndpointDefinition, ...] = (
    ...
    _EndpointDefinition(
        ...
        method="GET",
        path_template="/api/v1/documents/{document_id}/versions",
        actor="attacker_editor",
        expected_statuses=(404,),
    ),
    _EndpointDefinition(
        ...
        method="GET",
        path_template="/api/v1/documents/{document_id}/comments",
        actor="attacker_editor",
        expected_statuses=(404,),
    ),
    _EndpointDefinition(
        ...
        method="GET",
        path_template="/api/v1/documents/{document_id}/attachments",
        actor="attacker_editor",
...
WRITE_ENDPOINT_DEFINITIONS: tuple[_EndpointDefinition, ...] = (
    ...
    _EndpointDefinition(
        ...
        method="DELETE",
        path_template="/api/v1/documents/{document_id}/attachments/1",
        actor="attacker_manager",
        expected_statuses=(404, 403),
    ),
    _EndpointDefinition(
        ...
        actor="attacker_editor",
        expected_statuses=(404,),
        json_template={"content": "cross-tenant version"},
    ),
    _EndpointDefinition(
        name="comment_create",
        method="POST",
        ...
        actor="attacker_editor",
        expected_statuses=(404,),
        json_template={"content": "cross-tenant comment"},
    ),
    _EndpointDefinition(
